...
// </copyright>
// <summary>Methods to aid cryptography.</summary>
//-----------------------------------------------------------------------
...
namespace Useful.Security.Cryptography
{
    ...
    public static class CipherMethods
    {
        ...
        public static void DoCipher(SymmetricAlgorithm cipher, CipherTransformMode transformMode, Stream input, Stream output, Encoding outputEncodingOverride)
        {
            ...
            {
                Console.WriteLine(Resource.CryptoError, ex.Message);
                throw;
            }
            catch (UnauthorizedAccessException ex)
            {
                Console.WriteLine(Useful.Resource.FileError, ex.Message);
                throw;
            }
        }
        ...
        public static string DoCipher(SymmetricAlgorithm cipher, CipherTransformMode transformMode, string input)
        {
            if (cipher == null)
            {
            ...
            {
                IUsefulCryptoTransform usefulCryptoTransform = cryptoTransform as IUsefulCryptoTransform;
                ...
                else
                {
                    ...
                    ////    {
                    ////        CipherMethods.DoCipher(cipher, transformMode, inputStream, outputStream);
